    ...
    <ol>
        ...
        <li>
            ...
            <a class="fr-summary__link" id="summary-link-2" href="#anciennete">Ancienneté</a>
						<ol>
                <li>
									  <a class="fr-summary__link" id="summary-link-1-1" href="#anciennete-prise-en-compte-pour-l-avancement">Ancienneté prise en compte pour l'avancement</a>
                </li>
                <li>
								    <a class="fr-summary__link" id="summary-link-1-2" href="#anciennete-historique-prise-en-compte-pour-les-classements-reclassements">Ancienneté historique prise en compte pour les classements/reclassements</a>
									</li>
            </ol>
        </li>
			  <li>
									<a class="fr-summary__link" id="summary-link-2" href="#modalites-de-service">Modalités de service</a>
						<ol>
                <li>
...
### <span style="color:#3a6d48">Positions administratives</span>
????accordionsgroup
#### <span style="color:#27a658">Détachement</span>
????accordionsgroup
...
_Hypothèse du détachement sur emploi_
En application de l’article R1432-68 du code la santé publique :
...
Emplois de niveau 1 Hors échelle, lettre E, 2e chevron
Emplois de niveau 2 Hors échelle, lettre D, 3e chevron
Emplois de niveau 3 Hors échelle, lettre C, 3e chevron
Emplois de niveau 4 Hors échelle, lettre B bis, 2e chevron
...
_Hypothèse du détachement sur contrat_
Les directeurs dans les ARS membres du comité exécutif (COMEX), lorsqu'ils sont issus de la fonction publique, sont détachés sur un contrat de droit public.
...
_Pour un agent issu de la Fonction Publique de l’Etat_
...
#### <span style="color:#27a658">Disponibilité</span>
????accordionsgroup
...
### <span style="color:#3a6d48">Avancement</span>
????accordionsgroup
#### <span style="color:#27a658">Changement d'échelon</span>
????accordionsgroup
...
#### <span style="color:#27a658">Changement de grade</span>
????accordionsgroup
...
### <span style="color:#3a6d48">Ancienneté</span>
????accordionsgroup
#### <span style="color:#27a658">Ancienneté prise en compte pour l'avancement</span>
????accordionsgroup
...
#### <span style="color:#27a658">Ancienneté historique prise en compte pour les classements/reclassements</span>
????accordionsgroup
...
### <span style="color:#3a6d48">Modalités de service</span>
????accordionsgroup
#### <span style="color:#27a658">Temps incomplet</span>
????accordionsgroup

??? Peut-on autoriser le recrutement à temps incomplet (TI) de 10% à 70%, par tranche de 10 % voire de 5 % (ex : 15%) ?

L’article L 332-3 du CGFP prévoit que « _Les fonctions répondant à un besoin permanent et exercées dans le cadre d'un service à temps incomplet d'une durée n'excédant pas 70 % d'un service à temps complet sont assurées par des agents contractuels de l'Etat_ ». De plus, l’article L 612-13 du même code prévoit notamment que l'autorisation d'accomplir un travail à temps partiel est accordée de plein droit au fonctionnaire selon une quotité minimale de 50%.
...
#### <span style="color:#27a658">Temps partiel</span>
????accordionsgroup
...
Dans le Noyau RH-FPE, la règle de gestion est libellée ainsi : "_L'agent doit être employé depuis plus d'un an à temps complet_" avec le rappel suivant "_Suppression de l'exigence de continuité_". 
...
???
??? Comment gérer, dans le SIRH, le temps partiel d'un agent qui part en détachement ?
...
#### <span style="color:#27a658">Temps partiel pour raison thérapeutique</span>
????accordionsgroup
...
Ainsi, en application de l’article 23-3 du décret du 14 mars 1986, « _L'autorisation d'accomplir un service à temps partiel pour raison thérapeutique est accordée et, le cas échéant, renouvelée par période de un à trois mois dans la limite d'une année. (…)_ »
...
En revanche, en application de l’article 23-5 du décret du 14 mars 1986, « _Lorsque le fonctionnaire demande la prolongation de l'autorisation d'accomplir un service à temps partiel pour raison thérapeutique au-delà d'une période totale de trois mois, l'administration fait procéder sans délai par un médecin agréé à l'examen de l'intéressé, qui est tenu de s'y soumettre sous peine d'interruption de l'autorisation dont il bénéficie.
Le médecin agréé rend un avis sur la demande de prolongation au regard de sa justification médicale, de la quotité de travail sollicitée et la durée de travail à temps partiel pour raison thérapeutique demandée._ »
...
### <span style="color:#3a6d48">Rémunération</span>
????accordionsgroup
#### <span style="color:#27a658">Indemnités</span>
????accordionsgroup
...
#### <span style="color:#27a658">Traitement</span>
????accordionsgroup
...
[https://retraitesdeletat.gouv.fr/professionnels/le-versement-des-cotisations/les-etablissements-publics-nationaux-ou-organismes](https://retraitesdeletat.gouv.fr/professionnels/le-versement-des-cotisations/les-etablissements-publics-nationaux-ou-organismes)
???
...
### <span style="color:#3a6d48">Congés</span>
????accordionsgroup
...
### <span style="color:#3a6d48">Contrats</span>
????accordionsgroup
#### <span style="color:#27a658">CDI</span>
????accordionsgroup
...
????accordionsgroup
#### <span style="color:#27a658">Retraite</span>
????accordionsgroup
...
### <span style="color:#3a6d48">Données personnelles</span>
????accordionsgroup
#### <span style="color:#27a658">Adresses</span>
????accordionsgroup
...
#### <span style="color:#27a658">Etat civil</span>
????accordionsgroup
...
### <span style="color:#3a6d48">Actes administratifs / Bibliothèque des actes</span>
????accordionsgroup
#### <span style="color:#27a658">Absence d'actes</span>
????accordionsgroup
...
#### <span style="color:#27a658">Emploi du NIR</span>
????accordionsgroup
